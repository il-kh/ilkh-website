...
import Pageilkh from '@/public/images/wof-single-ilkh.jpg'
...
export default function CompetencySingle() {  
  return (
    <section className="relative">
      ...
      {/* Dark background */}
      <div className="absolute inset-0 bg-[#002240] pointer-events-none -z-10" aria-hidden="true">
        <div className="w-full h-full" data-aos="fade">
          <Image className="opacity-10 w-full h-full object-cover" src={Pageilkh} width={1440} height={497} alt="ilkh" />
        </div>
      </div>
        ...
        <div className="pt-32 pb-28 md:pt-40 md:pb-36">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="text-center">
              ...
              <h1 className="h2 font-playfair-display text-slate-100 mb-4">How Black Inc. Increased team collboration with ILKH</h1>
            </div>
