export default function ilkhSupport() {  
  return (
    <section className="relative">

      {/* Dark background */}
      <div className="absolute inset-0 bg-[#002240] pointer-events-none -z-10" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 font-playfair-display text-slate-100 mb-8">Advice and answers from the ILKH Team</h1>
            {/* Search form */}
