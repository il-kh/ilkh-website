---
title: Foundation Load Verification
value: foundation-load-verification
competencies:
...
## Equipment
- Plate Load Test
  - 1 plate load test set
  - Determines the bearing capacity of soil
  - Estimation of California Bearing Ratio (CBR) value of constrution layers
  - French Norm "NF P 94-117-1 Essai Plaque" and Eurocode 7-3.11 standard
- Dynamic Load Test
  - 1 High strain dynamic load test system
  - Pile diameter up to 1.5m
  - 20 tonnes drop hammer
  - 2 tonnes steel frame
  - Hydraulic trigger of the hammer ram drop
  - ASTM D4945-00
