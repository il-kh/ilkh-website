...
**Echo Sounder:**
- 1 Kongsberg EA440 single beam echo sounder
- 4 channel wide band transceiver
- Shallow and medium water depth applications
- Multiple applications: depth observations, side scan imaging, sub-bottom profiling

**Transducers:**
- 2 Kongsberg 500 kHz side scan transducer
- 1 Kongsberg 15-17 (15 kHz)
- 1 Airmar SS538 (200 kHz)

**Sound Velocity Probe:**
- 1 AML Oceanographic Micro X with SV Xchange sensor
- Measures sound velocity in depths up to 6,000 meters
- Provides real-time data to echo sounding systems
